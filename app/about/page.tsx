      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="container-custom">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div><h4 className="text-white font-bold mb-4">Product</h4><Link href="/services" className="block hover:text-white transition mb-2">Services</Link><Link href="/pricing" className="block hover:text-white transition mb-2">Pricing</Link><Link href="/blog" className="block hover:text-white transition">Blog</Link></div>
