  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-[#f1f5f9] mb-4">Cookie Policy</h1>
        ...
        <div className="glass-card-static p-8 sm:p-10 space-y-8 text-[#94a3b8]">
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">1. What Are Cookies</h2>
            ...
            <p className="mt-2">This policy should be read alongside our <Link href="/privacy" className="text-[#60a5fa] hover:text-[#3b82f6] transition">Privacy Policy</Link>, which provides further details on how we handle your personal data.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">2. How We Use Cookies</h2>
            <p>We use cookies for the following purposes:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#f1f5f9]">Essential functionality:</strong> To enable core features like authentication, security, and session management</li>
              <li><strong className="text-[#f1f5f9]">Preferences:</strong> To remember your settings and preferences (e.g. dark mode, cookie consent)</li>
              <li><strong className="text-[#f1f5f9]">Analytics:</strong> To understand how visitors interact with our platform so we can improve it (only with your consent)</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">3. Types of Cookies We Use</h2>

            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-6 mb-3">3.1 Strictly Necessary Cookies</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-white/10 rounded-lg overflow-hidden text-sm">
                <thead className="bg-white/5">
                  <tr>
                    <th className="px-4 py-3 text-left font-semibold text-[#f1f5f9]">Cookie Name</th>
                    <th className="px-4 py-3 text-left font-semibold text-[#f1f5f9]">Purpose</th>
                    <th className="px-4 py-3 text-left font-semibold text-[#f1f5f9]">Duration</th>
                    <th className="px-4 py-3 text-left font-semibold text-[#f1f5f9]">Provider</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/10">
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">sb-*-auth-token</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">sb-*-auth-token-code-verifier</td>
                    <td className="px-4 py-3">PKCE code verifier for secure OAuth authentication flows.</td>
                    <td className="px-4 py-3">Session</td>
                    <td className="px-4 py-3">Supabase</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">__stripe_mid</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">__stripe_sid</td>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-6 mb-3">3.2 Functional Cookies</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-white/10 rounded-lg overflow-hidden text-sm">
                ...
                <tbody className="divide-y divide-white/10">
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">cookie-consent</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">theme</td>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-6 mb-3">3.3 Analytics Cookies (Require Consent)</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-white/10 rounded-lg overflow-hidden text-sm">
                ...
                <tbody className="divide-y divide-white/10">
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">_va_id</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-[#60a5fa]">_va_ses</td>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">4. Managing Your Cookie Preferences</h2>
            <p>When you first visit our platform, you will see a cookie consent banner giving you the choice to:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#f1f5f9]">Accept All:</strong> Enables all cookies, including analytics</li>
              <li><strong className="text-[#f1f5f9]">Essential Only:</strong> Only strictly necessary and functional cookies are enabled; analytics cookies are blocked</li>
            </ul>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">Browser Controls</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">5. Third-Party Cookies</h2>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#f1f5f9]">Supabase:</strong> Authentication and session management</li>
              <li><strong className="text-[#f1f5f9]">Stripe:</strong> Secure payment processing and fraud prevention</li>
              <li><strong className="text-[#f1f5f9]">Vercel:</strong> Hosting and analytics (only with your consent)</li>
            </ul>
            <p className="mt-2">Please refer to each provider&apos;s cookie policy for more information about how they use cookies.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">6. Local Storage</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">7. Updates to This Policy</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">8. Contact Us</h2>
            ...
            <p className="mt-2">For more information about your rights under UK GDPR and how we protect your data, please read our <Link href="/privacy" className="text-[#60a5fa] hover:text-[#3b82f6] transition">Privacy Policy</Link>.</p>
          </section>
        </div>
