...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed bottom-4 right-4 z-50 p-3 rounded-full bg-white/5 backdrop-blur-md shadow-lg border border-white/10 hover:bg-white/10 hover:shadow-xl transition-all duration-200 group"
