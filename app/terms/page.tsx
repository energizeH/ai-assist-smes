  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-[#f1f5f9] mb-4">Terms of Service</h1>
        ...
        <div className="glass-card-static p-8 sm:p-10 space-y-8 text-[#94a3b8]">
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">1. Introduction and Acceptance</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">2. Service Description</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">3. Account Registration</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">4. Subscription Plans and Pricing</h2>
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">4.1 Plans</h3>
            <p>We offer the following subscription plans, billed monthly in British Pounds (GBP):</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#f1f5f9]">Starter:</strong> &pound;49/month</li>
              <li><strong className="text-[#f1f5f9]">Professional:</strong> &pound;149/month</li>
              <li><strong className="text-[#f1f5f9]">Enterprise:</strong> &pound;299/month</li>
            </ul>
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">4.2 Billing</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">4.3 Price Changes</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">4.4 Taxes</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">5. Free Trials and Promotions</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">6. Cancellation and Refunds</h2>
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">6.1 Cancellation by You</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">7. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">8. Intellectual Property</h2>
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">8.1 Our IP</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">8.2 Your Content</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">8.3 AI-Generated Content</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">9. Data Protection</h2>
            <p>We process your personal data in accordance with our <Link href="/privacy" className="text-[#60a5fa] hover:text-[#3b82f6] transition">Privacy Policy</Link> and in compliance with UK GDPR and the Data Protection Act 2018. Where you use the Service to process personal data of your own customers or contacts, you act as the data controller and we act as the data processor. You are responsible for ensuring your use of our Service complies with applicable data protection laws.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">10. Service Availability and SLA</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">11. Limitation of Liability</h2>
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">11.1 Exclusions</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">11.2 Cap</h3>
            ...
            <h3 className="text-lg font-semibold text-[#f1f5f9] mt-4 mb-2">11.3 Consumer Rights</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">12. Indemnification</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">13. Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">14. Changes to These Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">15. Governing Law</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">16. Severability</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#f1f5f9] mb-3">17. Contact Us</h2>
            <p>For any questions about these Terms of Service:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#f1f5f9]">Email:</strong> <a href="mailto:legal@aiassistsmes.co.uk" className="text-[#60a5fa] hover:text-[#3b82f6] transition">legal@aiassistsmes.co.uk</a></li>
              <li><strong className="text-[#f1f5f9]">Support:</strong> <a href="mailto:support@aiassistsmes.co.uk" className="text-[#60a5fa] hover:text-[#3b82f6] transition">support@aiassistsmes.co.uk</a></li>
